...
LedcStepper::LedcStepper(uint8_t step_pin, uint8_t dir_pin, uint8_t en_pin, bool invert_dir_pin)
{
    _step_pin = step_pin;
    ...
    xTaskCreate(stop_task, "ledc_stepperStopTask", 8192 * 4, (void *)this, PRIORITY_LIFT_STEPPERS, &_stop_task_handle);
