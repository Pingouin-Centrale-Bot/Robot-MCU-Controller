...
void setup()
{
    ...
    liftG = new Lift(M5_STP_PIN, M5_DIR_PIN, M_CHARIOT_EN_PIN, PUMP_VALVE1_PIN, ELECTRO1_PIN, M_CHARIOT_MICROSTEP, M5_DRIVER_ADDRESS, "Lift_left");
    liftD = new Lift(M6_STP_PIN, M6_DIR_PIN, M_CHARIOT_EN_PIN, PUMP_VALVE2_PIN, ELECTRO2_PIN, M_CHARIOT_MICROSTEP, M6_DRIVER_ADDRESS, "Lift_right");
