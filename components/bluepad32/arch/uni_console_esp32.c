...
void uni_console_init(void) {
    ...
    esp_console_dev_usb_cdc_config_t uart_config = ESP_CONSOLE_DEV_CDC_CONFIG_DEFAULT();
    ...
    ESP_ERROR_CHECK(esp_console_new_repl_usb_cdc(&uart_config, &repl_config, &repl));
